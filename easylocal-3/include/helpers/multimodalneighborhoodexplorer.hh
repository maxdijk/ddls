...
#else
      typedef std::tuple<std::function<void(const Solution &, typename BaseNeighborhoodExplorers::MoveType &)>...> _Void_ConstSolution_Move;;
      typedef std::tuple<std::function<bool(const Solution &, typename BaseNeighborhoodExplorers::MoveType &)>...> _Bool_ConstSolution_Move;
      typedef std::tuple<std::function<void(Solution&, const typename BaseNeighborhoodExplorers::MoveType &)>...> _Void_Solution_ConstMove;
      typedef std::tuple<std::function<CostStructure(const Solution &, const typename BaseNeighborhoodExplorers::MoveType &, const std::vector<double> &weights)>...> _CostStructure_ConstSolution_ConstMove;
#endif
